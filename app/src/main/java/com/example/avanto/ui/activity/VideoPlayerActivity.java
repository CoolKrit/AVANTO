...
import static com.example.avanto.ui.stateholder.adapter.VideoAdapter.videoFolder;
...
public class VideoPlayerActivity extends AppCompatActivity implements View.OnTouchListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (path!=null){
            ...
            Toast.makeText(this, "Path didn't exit", Toast.LENGTH_SHORT).show();
        }
    ...
    private void checkMultiAudioTrack(MediaPlayer mediaPlayer) {
        ...
        builder.setSingleChoiceItems(values, 0, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                mediaPlayer.start();
                Toast.makeText(VideoPlayerActivity.this, "In process :)", Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        ...
        switch (v.getId()){
            ...
            case R.id.videoView_play_pause_btn:
                if (videoView.isPlaying()){
                    videoView.pause();
                    playPause.setImageDrawable(getResources().getDrawable(R.drawable.ic_play_circle));
                }else {
                    videoView.start();
                    playPause.setImageDrawable(getResources().getDrawable(R.drawable.ic_pause_circle));
                }
                break;
        }
    }
    ...
    private class GestureDetector extends android.view.GestureDetector.SimpleOnGestureListener{
        ...
        public boolean onDoubleTap(MotionEvent event) {
            if (event.getX() < (sWidth / 2)) {
                ...
                Toast.makeText(VideoPlayerActivity.this, "-5sec", Toast.LENGTH_SHORT).show();
