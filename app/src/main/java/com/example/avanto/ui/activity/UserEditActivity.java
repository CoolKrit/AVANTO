...
import com.example.avanto.databinding.ActivityUserEditBinding;
...
public class UserEditActivity extends AppCompatActivity {
        ...
        reference.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(UserEditActivity.this, "Failed uploading image due to" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    private void updateProfile(String imageUrl) {
        ...
        if (imageUri != null) {
            hashMap.put("userImage", "" + imageUrl);
        }
        ...
        databaseReference.child(firebaseAuth.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(UserEditActivity.this, "Profile updated", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(UserEditActivity.this, "Failed updating to db due to" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(UserEditActivity.this, "Cancelled picking", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
